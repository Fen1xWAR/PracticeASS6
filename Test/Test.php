...
<div class="container-fluid d-flex flex-grow-1">
    <div class="container-fluid p-5 d-xxl-flex">
        <div class="row">
            <div class="col-xl-1">
                <div id="nav-panel" class="sticky-top mt-5 border" style="top: 4em;">
                    <ul id="nav-items" class="nav flex-column align-items-center">




<!--                        <li class="nav-item">-->
<!--                            <a class="nav-link active" href="#" data-component-id="1">-->
...
<!--                        </li>-->
            ...
            <div class="text-wrap col-xl-11" style="text-align: justify">
            ...
            $.ajax({
                ...
                success: function (html) {
                    if (html) {
                        ...
                        $('[data-block-id="' + componentId + '"]').addClass('active');
                    } else {
